	...
	public void run() {
		...
		while (true) {
			...
			switch (state) {			
    			...
    			case READY:
    				String patrodIdStr = Main.getResponseId();
    			...
    			case SCANNING:
					if (Integer.parseInt(Main.getResponseItem()) < 5) {
						String itemIdStr = Main.getResponseItem();
    			...
    			case FINALISING:
    				String answer = Main.getResponseCommit();
